...
- (UIView *)createContainerView
{
    if (containerView == NULL) {
        containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 300, 270)];
    }
...
//    dialogContainer.layer.borderWidth = 1;
    ...
    lineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:0.0f];
...
- (void)addButtonsToView: (UIView *)container
{
	...
	NSString *sClose = @"Cansel";
	NSString *sCloseIndex = [buttonTitles objectAtIndex:0];
	
	NSString *sClose2 = @"Cansel2";
	NSString *sClose2Index = [buttonTitles objectAtIndex:1];
	
	NSString *sInfo = @"Info";
	NSString *sInfoIndex = [buttonTitles objectAtIndex:2];
	...
	if (checkForClose) {
					...
					[closeButton setFrame:CGRectMake(50, 160, 22, 22)];
			        [closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
					[closeButton setTag:0];

					[closeButton setBackgroundImage:[UIImage imageNamed:@"cansel"] forState:UIControlStateNormal];
	...
	if (checkFor2Close) {
		...
		[closeButton setFrame:CGRectMake(50, 265, 22, 22)];
		[closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
		[closeButton setTag:0];
	...
	if (checkForInfo) {
					...
					UIButton *closeButton = [UIButton buttonWithType:UIButtonTypeCustom];
					[closeButton setFrame:CGRectMake(165, 160, 90, 30)];
					[closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
					[closeButton setTag:1];

					[closeButton setBackgroundImage:[UIImage imageNamed:@"moreInfo"] forState:UIControlStateNormal];
					[closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f] forState:UIControlStateNormal];
					[closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f] forState:UIControlStateHighlighted];
					[closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
					[closeButton.layer setCornerRadius:kCustomIOS7AlertViewCornerRadius];
	...
	if (checkForHelp) {
		UIButton *closeButton = [UIButton buttonWithType:UIButtonTypeCustom];
		[closeButton setFrame:CGRectMake(165, 265, 90, 30)];
		[closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
		[closeButton setTag:0];
		
		[closeButton setBackgroundImage:[UIImage imageNamed:@"helpButton"] forState:UIControlStateNormal];
		[closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.5f blue:1.0f alpha:1.0f] forState:UIControlStateNormal];
		[closeButton setTitleColor:[UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.5f] forState:UIControlStateHighlighted];
		[closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:14.0f]];
		[closeButton.layer setCornerRadius:kCustomIOS7AlertViewCornerRadius];
...
//		[closeButton setFrame:CGRectMake(230, 5, 22, 22)];
//        [closeButton addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
